...
namespace Persistence.Migrations
{
    ...
    [Migration("20240703005921_add-unique-national-identity")]
    partial class adduniquenationalidentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("73a4fc56-e8ac-47b5-b43a-c31ca9062219"),
                            Address = "Tekirdağ",
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = new byte[] { 201, 255, 144, 237, 121, 195, 64, 175, 20, 4, 237, 76, 48, 174, 231, 203, 95, 154, 132, 17, 187, 121, 209, 161, 247, 78, 191, 156, 90, 226, 40, 200, 249, 151, 192, 138, 27, 168, 122, 236, 225, 238, 59, 28, 236, 228, 13, 92, 168, 144, 83, 236, 18, 102, 11, 249, 200, 152, 124, 222, 134, 228, 194, 70 },
                            PasswordSalt = new byte[] { 193, 146, 207, 255, 195, 255, 226, 77, 9, 37, 19, 130, 72, 68, 56, 195, 169, 106, 141, 106, 20, 199, 187, 250, 55, 143, 9, 142, 251, 102, 221, 115, 167, 73, 9, 117, 175, 254, 240, 26, 207, 54, 215, 155, 242, 197, 125, 171, 181, 224, 168, 59, 168, 158, 106, 183, 65, 182, 31, 132, 153, 190, 82, 215, 72, 154, 44, 0, 197, 216, 101, 5, 184, 49, 46, 144, 26, 10, 164, 25, 85, 220, 26, 8, 210, 209, 125, 70, 167, 62, 17, 15, 245, 197, 240, 38, 48, 178, 248, 252, 159, 106, 162, 244, 59, 212, 179, 181, 39, 221, 210, 190, 194, 45, 211, 251, 10, 107, 166, 58, 106, 35, 17, 134, 36, 245, 6, 254 },
                            Phone = "05279563492"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3567e31f-6635-4d58-8b9d-78db3d96d064"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("73a4fc56-e8ac-47b5-b43a-c31ca9062219")
                        });
                });
